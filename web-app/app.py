...
def predict():
    ...
    if form.submit():
        ...
        response_scoring = requests.post("https://us-south.ml.cloud.ibm.com/ml/v4/deployments/<deployment-id-goes-here>/predictions?version=<DATE>", json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
